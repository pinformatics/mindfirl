...
- Upload test_2_sample_1.csv and test_2_sample_2.csv and block on last name. 
- Verify there are 5 pairs. All of them should be matches. 
- Submit and download report. The output should be test_2_iter1_lname_results.csv

### Iteration 2

- Upload the test_2_iter1_lname_results.csv. 
- Block on voter registry number. 
- You should get 1 comparison for empty voter reg number. It is not a match. 
- Submit and download report. The output should be test_2_iter2_voter_results.csv

### Iteration 3

- Upload the test_2_iter2_voter_results.csv. 
- Block on dob. 
- You should get 3 comparisons. 2 of them are matches and 1 of them isn't.  
- Submit and download report. The output should be test_2_iter3_dob_results.csv
...
- The linking procedure with one blocking variable followed by another is given here. 
...
In these 5 group comparisons, the last group (id-146) alone may not refer to the same entity. Such compairons cannot be achieved in one trial using any grouping variable(s) but can only be achieved by successive compairisons as shown. 
